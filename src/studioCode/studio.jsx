    ...
    <section className="StudioContainer">
      <nav className="navBarElements">
        <div className="ListItemsHolder">
          <div
            className="material-symbols-rounded RBtn "
            onClick={addRectangle}
          >
            square
          </div>
          <div className="material-symbols-rounded RBtn " onClick={addCircle}>
            circle
          </div>
          <div
            className="material-symbols-rounded RBtn rotation "
            onClick={addLine}
          >
            line_end
          </div>
          <div className="material-symbols-rounded RBtn" onClick={addDraw}>
            edit
          </div>
          <div className="material-symbols-rounded RBtn" onClick={addText}>
            title
          </div>
          <div
            className="material-symbols-rounded RBtn"
        ...
        >
          <span className="material-symbols-rounded RBtn ">delete</span>
          Delete All
        </motion.button>
      </nav>
      <div
      ...
      >
        ...
        <div className="sideBarModification">
          <div className="holder">
            <h2 className="TitleHolder">Background</h2>
            <br />
          ...
          <br />
          <div className="holder">
            <h2 className="TitleHolder">Stroke</h2>
            <br />
            <div className="ElementHolder">
              {BgArray.map((elem) => (
                <motion.div
